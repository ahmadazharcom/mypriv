                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-12">
              							<textarea class="form-control" name="description" placeholder="Leave a comment here" id="floatingTextarea" rows="4"></textarea>
                							@error('description')
                								<div class="invalid-feedback">
                									{{ $message }}
                								</div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
										...
										<img class="dlogo img-preview4 img-fluid" src="{{ asset('form09/images/products.png') }}">
