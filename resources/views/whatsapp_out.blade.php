          ...
          <div class="row justify-content-center">
            <div class="col-md-12">
              <div class="form-block">
                  ...
                  <center><h3>Hantar Mesej Keluar ke <strong>WhatsApp</strong></h3><p class="mb-4">Borang ini hanya untuk menghantar pesanan melalui api WhatsApp.</p></center>
                  
                  
                </div>
                <form action="/whatsapp/whatsapp_out" method="post">
                    @csrf
